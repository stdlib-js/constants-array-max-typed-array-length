...
```javascript
MAX_TYPED_ARRAY_LENGTH = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-array-max-typed-array-length@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-array-max-typed-array-length/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/constants-array-max-typed-array-length/actions/workflows/test.yml?query=branch:v0.2.3
